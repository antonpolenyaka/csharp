...
namespace Sally7
{
    internal static class S7ConnectionHelpers
    {
        public static int BuildConnectRequest(in Span<byte> buffer, in Tsap sourceTsap, in Tsap destinationTsap,
            BigEndianShort sourceReference = default)
        {
            ...
            message.ConnectionRequest.SourceReference = sourceReference;
        ...
        public static bool ParseConnectionConfirm(in ReadOnlySpan<byte> buffer)
        {
            ...
            bool isCCConnectConfirm = cc.ConnectionConfirmAndCredit == 0xD0;
